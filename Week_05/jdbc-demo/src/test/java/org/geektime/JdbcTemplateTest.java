...
public class JdbcTemplateTest {
    ...
    public void loadJdbcProperties() throws IOException, SQLException, ReflectiveOperationException {
        ...
        jdbcTemplate = new JdbcTemplate(DataBase.MYSQL_8,
    ...
    public void testInert() {
        ...
        Assert.assertEquals(names.size(), jdbcTemplate.executeUpdate(sql.toString(), names.toArray(new String[0])));
    }
    ...
    public void testSelectClass() {
        String sql = "select id,name from t_java_course where id>?";
        System.out.println(jdbcTemplate.query(Student.class, sql, 1));
    }
}