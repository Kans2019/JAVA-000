...
public class ByteBuddyProxyBuilderTest {
    private static final Logger logger = Logger.getLogger(ByteBuddyProxyBuilderTest.class);
    ...
    public void executeProxy() {
        ...
        proxyTest = new ByteBuddyProxyBuilder<>(proxyTest)
